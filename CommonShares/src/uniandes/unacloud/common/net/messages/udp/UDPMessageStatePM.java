package uniandes.unacloud.common.net.messages.udp;
...
public class UDPMessageStatePM extends UnaCloudMessageUDP{
	 ...
	 */
	public UDPMessageStatePM(String ip, int port, String host, String hostUser, Long freeSpace, Long dataSpace, String version) {
		super(ip, port, host, UDPMessageEnum.STATE_PM);
