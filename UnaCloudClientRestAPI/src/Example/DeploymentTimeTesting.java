...
public class DeploymentTimeTesting {
     ...
     */
    public void deploymentTimeTesting2(int iterations, int idCluster,int imageId, int[] quantities, int maxCleanableMachines, String significantHostName) throws Exception {
        Date limite=format.parse("2018/05/13 06:00:00");
...
//                if(!noErrors) throw new Exception("There are failed deployments");
    ...
    public void deploymentTimeTesting3(int iterations, int idCluster,int imageId, int[] quantities, int maxCleanableMachines, String significantHostName) throws Exception {
        Date limite=format.parse("2018/05/13 06:00:00");
        for (int j = 2; j < 3; j++) {
            for (Integer qty : quantities) {
                //Clean the cache of the given machines or of given numbers.
