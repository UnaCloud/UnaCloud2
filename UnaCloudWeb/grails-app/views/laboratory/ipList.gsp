                                 ...
                                 <td>
                                  ...
                                  <td class="column-center">
	                                  <div class="btn-group">
		                                  ...
		                                  <a title="Delete" class="delete_ip btn btn-default" data-id = "${ip.id}" data-method = "delete" href="${createLink(uri: '/admin/lab/' + lab.id + '/pool/' + pool.id + '/ip', absolute: true)}" data-toggle="tooltip"><i class='fa fa-trash-o' ></i></a>
			                              <g:if test="${!ip.state.equals(IPEnum.DISABLED)}">
