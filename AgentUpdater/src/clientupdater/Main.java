...
public class Main {
    ...
    public static void startClient(int opcion) {
        if(opcion==ClientConstants.DELAY){
            opcion=ClientConstants.RUN;
            try {
                Thread.sleep(5000);
        ...
        try {
            ...
            Runtime.getRuntime().exec(new String[]{"java","-jar",ClientConstants.AGENT_JAR,opcion+""});
        } catch (Throwable t) {
